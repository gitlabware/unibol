        ...
        <legend> REGISTRO DE ALUMNOS </legend>
			<div class="row-fluid">
				...
				<div class="span4">
					...
					<?php echo $this->Form->select('carrera_id',$carreras, array('required', 'class'=>'select'))?>
				</div>
				<div class="span4">
					<label>
						Malla Curricular: 
            ...
            <div class="row-fluid">
                ...
                <div class="span3">
					...
					<?php echo $this->Form->text('ap_materno', array('class'=>'validate[required] text-input')); ?>
				</div>
                <div class="span3">
					<label>
						Nombres: 
            ...
            <select  name="data[User][estado_civil]">
				...
				<div class="span4">
					...
					<?php echo $this->Form->text('lugar_nac', array('required')); ?>
				</div>
                </div>

                ...
                <div class="sidebar_inner">
                    ...
                    <div id="side_accordion" class="accordion">
                        ...
                        <div class="accordion-group">
										...
										<div class="accordion-body collapse in" id="m2">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													<li>
                        ...
                        <div class="accordion-group">
										<div class="accordion-heading">
											<a href="#m4" data-parent="#side_accordion" data-toggle="collapse" class="accordion-toggle">
												<i class="icon-user"></i> Carreras
											</a>
										</div>
										<div class="accordion-body collapse" id="m4">
											<div class="accordion-inner">
												<ul class="nav nav-list">
													<li>
                        ...
                        <div class="accordion-group">
						      <div class="accordion-heading">
									...
									<i class="icon-folder-close"></i> Accion "Alumnos"
									</a>
							 </div>

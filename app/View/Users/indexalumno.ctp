        ...
        <table class="table table-striped table-bordered dTableR" id="dt_a">
            ...
            <tbody>
                <?php $i=1; foreach ($users as $u): ?>
                    <tr>
                        <td><?php echo $i; $i++; ?></td>                                                  
                        <td><?php echo $u['User']['nombre']; ?></td>
                        <td><?php echo $u['User']['ap_paterno']; ?></td>
                        ...
                        <?php 
                                echo $this->Html->image("iconos/materiales.png", array(
                                    "title" => "Asignar Materiales",
                                    'url' => array('action' => 'alumnosmateriales', $alumn['Alumno']['id'])
                                ));?> 
                            <?php 
                                echo $this->Html->image("iconos/permiso.png", array(
                                    "title" => "Asignar Permiso",
                                    'url' => array('action' => 'alumnospermisos', $alumn['Alumno']['id'])
                                ));?>

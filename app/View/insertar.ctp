<div class="span12">
    <h3 class="heading">EDITAR AL ALUMNO</h3>    
    <?php echo $this->Form->create('User',array('id'=>'fomID')); ?> 
    <div class="formSep">
        <legend> REGISTRO DE ALUMNOS </legend>
			<div class="row-fluid">
				...
				<div class="span4">
					...
					<?php echo $this->Form->select('carrera_id',$carreras, array('class'=>'validate[required] text-input'))?>
				</div>
				<div class="span4">
					<label>
						Malla Curricular: 
					...
					<?php echo $this->Form->select('malla_curricular',$mallas, array('class'=>'validate[required] text-input'))?>
				</div>
            ...
            <div class="row-fluid">
                <div class="span4">
					...
					<?php echo $this->Form->select('semestre_id',$semestres); ?>
				</div>
            ...
            <div class="row-fluid">
                <div class="span4">
					...
					<?php echo $this->Form->text('ci', array('class'=>'validate[required, custom[integer]] text-input')); ?>
				</div>
                <div class="span4">
					<label>
						Expedido:
					...
					<select  name="data[Alumno][ci_expedido]" >
            ...
            <select  name="data[User][estado_civil]">
                ...
                <div class="span4">
					...
					<?php echo $this->Form->date('fecha_nac',array('id'=>'dp1','data-date-format'=>'yyyy/mm/dd')); ?>
				</div>
				<div class="span4">
					<label>
						Lugar Nacimiento:
                ...
                <div class="span4">
                    ...
                    <input  type="hidden" id="AlumnoPais" name="data[User][pais_id]" value="1" readonly="readonly">
            ...
            <div class="row-fluid">
                <div class="span4">
					...
					<?php echo $this->Form->select('organizacione_id', $organizaciones, array('class'=>'validate[required] text-input')) ?>
				</div>
